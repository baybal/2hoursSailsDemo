...
module.exports.bootstrap = async function(done) {
  ...
  await Test.createEach([
    { emailAddress: 'admin@test.com', phone: '+8615367676767', firstName: 'Testman', lastName: 'Testmanson', isAdmin: true, password: await sails.stdlib('passwords').hashPassword('test') },
  ]);
